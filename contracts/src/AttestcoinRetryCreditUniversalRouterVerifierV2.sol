...
contract AttestcoinRetryCreditUniversalRouterVerifierV2 {
    ...
    constructor(
        RetryCreditUniversalRouterPredicateV2 predicate_,
    ...
    function verifyRelease(BatchProof calldata proof, RetryCreditUniversalRouterPredicateV2.Rule calldata rule)
        external
